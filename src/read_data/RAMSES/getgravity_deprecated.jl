...
"""
function getgravity_deprecated( dataobject::InfoType, var::Symbol;
                    lmax::Real=dataobject.levelmax,
                    xrange::Array{<:Any,1}=[missing, missing],
                    yrange::Array{<:Any,1}=[missing, missing],
                    zrange::Array{<:Any,1}=[missing, missing],
    ...
    return getgravity_deprecated(dataobject, vars=[var],
                    lmax=lmax,
...
function getgravity_deprecated( dataobject::InfoType, vars::Array{Symbol,1};
                    lmax::Real=dataobject.levelmax,
                    xrange::Array{<:Any,1}=[missing, missing],
                    yrange::Array{<:Any,1}=[missing, missing],
                    zrange::Array{<:Any,1}=[missing, missing],
    ...
    return getgravity_deprecated(dataobject,
                    vars=vars,
                    lmax=lmax,
                    xrange=xrange, yrange=yrange, zrange=zrange, center=center,
                    range_unit=range_unit,
...
function getgravity_deprecated( dataobject::InfoType;
                      lmax::Real=dataobject.levelmax,
                      vars::Array{Symbol,1}=[:all],
                      xrange::Array{<:Any,1}=[missing, missing],
                      yrange::Array{<:Any,1}=[missing, missing],
    ...
    if read_cpu
        vars_1D, pos_1D, cpus_1D = getgravitydata_deprecated( dataobject, length(nvarg_list),
                                         nvarg_corr, lmax, ranges,
                                         print_filenames, show_progress, read_cpu, isamr  )
    else
        vars_1D, pos_1D          = getgravitydata_deprecated( dataobject, length(nvarg_list),
                                         nvarg_corr, lmax, ranges,
                                         print_filenames, show_progress, read_cpu, isamr  )
    end

    # prepare column names for the data table
    names_constr = preptablenames_deprecated(length(dataobject.gravity_variable_list), nvarg_list, used_descriptors, read_cpu, isamr)
...
function preptablenames_gravity_deprecated(nvarg::Int, nvarg_list::Array{Int, 1}, used_descriptors::Dict{Any,Any}, read_cpu::Bool, isamr::Bool)
