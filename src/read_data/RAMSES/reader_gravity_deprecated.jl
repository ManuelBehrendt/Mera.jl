...
function getgravitydata_deprecated( dataobject::InfoType,
                        Nnvarh::Int,
...
# -----------------------------------------------------------
    ...
    @showprogress p for k=1:ncpu_read #Reading files... @showprogress 1 ""
        ...
        for ilevel=1:lmax
            ...
            ny_full=nx_full
            nz_full=nx_full
            xc = geometry_deprecated(twotondim_float, ilevel, xc) # @trace
            ...
            # Compute map
            if ngrida>0
                vars_1D, pos_1D, cpus_1D = loopovercellshydro_deprecated(twotondim,
                                                                ngrida, ilevel, lmax,
                                                                xg, xc, son, xbound,
