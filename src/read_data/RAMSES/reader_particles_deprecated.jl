function getparticledata_deprecated( dataobject::InfoType,
                        Nvarp::Int,
    ...
    if read_cpu
        if dataobject.descriptor.pversion == 0
            pos_1D, vars_1D, cpus_1D, identity_1D, levels_1D = readpart_deprecated( dataobject,
        ...
        elseif dataobject.descriptor.pversion > 0
            pos_1D, vars_1D, cpus_1D, identity_1D, family_1D, tag_1D, levels_1D = readpart_deprecated( dataobject,
                                     Nvarp=Nvarp, nvarp_corr=nvarp_corr,
                                     lmax=lmax,
                                     ranges=ranges,
                                     cpu_list=cpu_list,
        ...
        if dataobject.descriptor.pversion == 0
            pos_1D, vars_1D, identity_1D, levels_1D = readpart_deprecated( dataobject,
                                     Nvarp=Nvarp, nvarp_corr=nvarp_corr,
                                     lmax=lmax,
                                     ranges=ranges,
                                     cpu_list=cpu_list,
        ...
        elseif dataobject.descriptor.pversion > 0
            pos_1D, vars_1D, identity_1D, family_1D, tag_1D, levels_1D = readpart_deprecated( dataobject,
                                     Nvarp=Nvarp, nvarp_corr=nvarp_corr,
                                     lmax=lmax,
                                     ranges=ranges,
                                     cpu_list=cpu_list,
...
function readpart_deprecated(dataobject::InfoType;
                            Nvarp::Int,
                            nvarp_corr::Array{Int,1},
