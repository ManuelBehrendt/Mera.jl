...
!!! tip "Run it yourself"
    This page is also an executable **Jupyter notebook** — [open / download `07_multi_Mera_Files.ipynb`](https://github.com/ManuelBehrendt/Notebooks/blob/master/Mera-Docs/version_2/07_multi_Mera_Files.ipynb). The notebooks run end-to-end and double as part of Mera's test suite.
