...
```
    ...
    [0m[1m[Mera]: 2020-01-28T19:40:59.92[22m
    ...
    [0m[1m[Mera]: Get hydro data: 2020-01-28T19:41:07.433[22m
    ...
    [0m[1m[Mera]: Get particle data: 2020-01-28T19:43:56.619[22m
    ...
    [0m[1m[Mera]: Get clump data: 2020-01-28T19:44:02.353[22m
...
### Create a New DataSetType from The Filtered Data Table
...
Create an array which represents the masked cells by true.
The function checks if the following condition is true or false for each row/cell in the data table:
