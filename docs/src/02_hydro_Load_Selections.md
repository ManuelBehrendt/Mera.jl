...
!!! tip "Run it yourself"
    This page is also an executable **Jupyter notebook** — [open / download `02_hydro_Load_Selections.ipynb`](https://github.com/ManuelBehrendt/Notebooks/blob/master/Mera-Docs/version_2/02_hydro_Load_Selections.ipynb). The notebooks run end-to-end and double as part of Mera's test suite.
