...
!!! tip "Run it yourself"
    This page is also an executable **Jupyter notebook** — [open / download `paraview_intro.ipynb`](https://github.com/ManuelBehrendt/Notebooks/blob/master/Mera-Docs/version_1/paraview/paraview_intro.ipynb). The notebooks run end-to-end and double as part of Mera's test suite.
