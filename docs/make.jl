...
makedocs(modules = [Mera],
		...
		assets = ["assets/custom.css", "assets/custom.js", "assets/ambient_music_player.js"],  # Load order: CSS first, JS second, music player last
		canonical = "https://manuelbehrendt.github.io/Mera.jl/",
		footer = "© 2024 Manuel Behrendt. Built with [Documenter.jl](https://github.com/JuliaDocs/Documenter.jl) and [Julia](https://julialang.org).",
