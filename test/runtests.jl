...
@testset "Mera.jl" begin
    ...
    @testset "Quality & Fundamentals" begin
        ...
        tinclude("76_amrex_reader_tests.jl")          # data-free: AMReX/BoxLib container + Quokka layer (synthetic 2-level plotfile; geometry, leaves, temperature cascade, particles)
        tinclude("77_jamr_cli_tests.jl")              # data-free: the `jamr` command line (parsing, window arithmetic, field resolution, figures when matplotlib is present)
